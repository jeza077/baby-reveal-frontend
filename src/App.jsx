    ...
    <>
      <main className="invitation-container">
        ...
        <Fade
          ...
          triggerOnce={true}
        >
          <img src="../public/images/conejo-azul.png" alt="" />
        </Fade>
      ...
      <section className="clothes">
        <img src="../public/images/clothes.png" alt="baby-clothes" />
      ...
      <section className="gift">
        <div className="imgs">
          <img src="../public/images/panal.png" alt="panal-baby" />
          <img src="../public/images/toallitas.png" alt="toallitas-baby" />
        </div>
